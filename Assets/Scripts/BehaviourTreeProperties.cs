...
public class BehaviourTreeProperties
{
    ...
    public static Vector2 CallNumberSize(){
        Vector2 guiNodeSize = BehaviourTreeProperties.GuiNodeSize();
        return new Vector2(
            guiNodeSize.x/6f,
            guiNodeSize.x/6f
        );
    ...
    public static Color CallNumberColor(){return BehaviourTreeProperties.DefaultColor();}
    ...
    public static Vector2 InitDecoratorPos(){
        return new Vector2(0, BehaviourTreeProperties.GuiNodeSize().y*.21f);
    }
